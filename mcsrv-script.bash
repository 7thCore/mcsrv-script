...
case "$1" in
	...
	-timer_two)
		...
		;;
	*)
	echo "Usage: $0 {start|stop|restart|saveon|saveoff|save|cleardrops|sync|backup|autobackup|deloldbackup|install_aliases|rebuild_tmux_config|rebuild_services|rebuild_update_script|disable_services|enable_services|reload_services|update|status|install}"
	exit 1
	;;
esac
